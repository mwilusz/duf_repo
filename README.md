...
- `100_duf_summary_diff.ipynb` zawiera kod pozwalający na przedstawienie rezultatów dotyczących różnic w anotacjach dla odpowiadających sobie par domen (do części "Dodatek B")
...
- `summary_results_v2.zip`, `summary_diff.zip` pliki zawerające końcowe skompresowane foldery z podsumowaniem tworzonym przez odpowiednio pliki `100_duf_summary.ipynb` i`100_duf_summary_diff.ipynb`
